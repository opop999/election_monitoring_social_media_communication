# EXTRACT ALL YESTERDAY'S YOUTUBE CONTENT, ADD IT TO THE FULL LIST
...
yt_posts_yesterday <- function(server, start_date, end_date, dir_name, sort, descending) {
...
yt_posts_yesterday(server, start_date, end_date, dir_name, sort, descending)
